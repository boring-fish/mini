    ...
    <form class="layui-form">
      <div class="user_left">
        ...
        <div class="layui-form-item userAddress">
          ...
          <div class="layui-input-inline">
            ...
            <div class="layui-unselect layui-form-select layui-select-disabled">
              <div class="layui-select-title">
                <input
                  type="text"
                  placeholder="请选择市"
        ...
        <div class="layui-form-item">
          ...
          <div class="layui-input-block userHobby">
            ...
            <div
              ...
              lay-skin=""
            >
              <span>Javascript</span><i class="layui-icon"></i>
            </div>
            <input
              type="checkbox"
              name="like[html]"
            ...
            <div
              ...
              lay-skin=""
            >
              <span>HTML(5)</span><i class="layui-icon"></i>
            </div>
            <input
              type="checkbox"
              name="like[css]"
            ...
            <div
              ...
              lay-skin=""
            >
              <span>CSS(3)</span><i class="layui-icon"></i>
            </div>
            <input
              type="checkbox"
              name="like[php]"
            ...
            <div
              ...
              lay-skin=""
            >
              <span>PHP</span><i class="layui-icon"></i>
            </div>
            <input
              type="checkbox"
              name="like[.net]"
            ...
            <div
              ...
              lay-skin=""
            >
              <span>.net</span><i class="layui-icon"></i>
            </div>
            <input
              type="checkbox"
              name="like[ASP]"
            ...
            <div
              ...
              lay-skin=""
            >
              <span>ASP</span><i class="layui-icon"></i>
            </div>
            <input
              type="checkbox"
              name="like[C#]"
            ...
            <div
              ...
              lay-skin=""
            >
              <span>C#</span><i class="layui-icon"></i>
            </div>
            <input
              type="checkbox"
              name="like[Angular]"
            ...
            <div
              ...
              lay-skin=""
            >
              <span>Angular</span><i class="layui-icon"></i>
            </div>
            <input
              type="checkbox"
              name="like[VUE]"
            ...
            <div
              ...
              lay-skin=""
            >
              <span>VUE</span><i class="layui-icon"></i>
            </div>
            <input
              type="checkbox"
              name="like[XML]"
            ...
            <div
              ...
              lay-skin=""
            >
              <span>XML</span><i class="layui-icon"></i>
            </div>
          </div>
        </div>
        <div class="layui-form-item">
      ...
      <div class="user_right">
        <div class="layui-box layui-upload-button">
          <form
            key="set-mine"
            target="layui-upload-iframe"
            method="post"
            enctype="multipart/form-data"
            action="../../json/userface.json"
          >
            <input
              type="file"
              name="userFace"
              class="layui-upload-file"
              lay-title="掐指一算，我要换一个头像了"
            >
          </form>
          <span class="layui-upload-icon"><i class="layui-icon"></i>掐指一算，我要换一个头像了</span>
        </div>
        <img
          id="userFace"
          src="../assets/logo.png"
